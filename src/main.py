...
def main(opt):
  ...
  comet_logger.log_code('./lib/model/networks/resdcn.py')
  comet_logger.log_code('./lib/model/networks/dla.py')
  ...
  for epoch in range(start_epoch + 1, opt.num_epochs + 1):
    ...
    if opt.val_intervals > 0 and epoch % opt.val_intervals == 0:
      ...
      comet_logger.log_model("CenterTrack", os.path.join(opt.save_dir,
